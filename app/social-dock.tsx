export default function SocialDock() {
  return <aside className="social-dock" aria-label="XBASE 소셜 채널">
    ...
    <a className="social-threads" href="https://www.threads.com/@xbase_lab?hl=ko" target="_blank" rel="noopener noreferrer" aria-label="XBASE Threads 새 탭에서 열기" title="Threads · @xbase_lab">
