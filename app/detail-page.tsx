...
export default function DetailPage({ slug }: { slug: DetailSlug }) {
  ...
  return <main className={`detail-page detail-${slug}`}>
    ...
    <header className="site-header detail-header">
      <a className="wordmark" href="/"><Image src="/xbase-logo.png" alt="" width={32} height={32} priority /><b>XBASE<span>.</span></b></a>
    ...
    <footer><a className="wordmark inverse" href="/"><Image src="/xbase-logo.png" alt="" width={30} height={30}/><b>XBASE<span>.</span></b></a><p>개인 포트폴리오 · 프로젝트 내용은 공개 가능한 범위에서 재구성했습니다.</p><p>© 2026 XBASE.</p></footer>
  </main>
}
