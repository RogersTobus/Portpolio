...
const experiences = [
  ...
  ["2026", "명동 치과의원", "Marketing · Growth", "월 1억 원 규모의 광고 운영과 고객 퍼널 분석을 연결해 예약 전환과 고객 경험을 개선했습니다."],
  ["2025", "강남 안과의원", "Marketing · Partnership", "마케팅과 제휴, 대외협력을 맡아 새로운 고객 접점과 프로젝트를 기획했습니다."],
  ["2024", "국내 이커머스 물류기업", "Installation Service · CX", "전국 15개 캠프의 운영과 품질을 관리하고, 데이터와 VOC를 바탕으로 설치 취소율을 27%에서 4%로 낮췄습니다."],
  ["2015 — 2024", "대한민국 육군", "Leadership · Operations", "교육·평가 체계를 운영하고 훈련 프로세스를 개선하며 책임, 판단, 실행의 기본기를 익혔습니다."],
];
